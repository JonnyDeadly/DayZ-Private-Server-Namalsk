...
Extract downloaded archive nc_pathfinder_full.7z into your Arma II OA folder and run 
Arma II Combined Operations with -mod=@NC parameter (default folder name).
...
Eawes (testing, translation, developer support, master of paths for AI)
